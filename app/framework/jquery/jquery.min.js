 ...
 * @returns {*} 订单类型+当前时间
 */
function billFormat(billType,fmt) {
    var year,month,date,hour,minute;
    year = fmt.getFullYear();
    month = fmt.getMonth()+1;
    date = fmt.getDate();
    hour = fmt.getHours();
    minute = fmt.getMinutes();
    second = fmt.getSeconds();
    return billType+year+addZero(month)+addZero(date)+addZero(hour)+addZero(minute)+addZero(second);
